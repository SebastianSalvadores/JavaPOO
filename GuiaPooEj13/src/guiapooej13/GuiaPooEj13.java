...
public class GuiaPooEj13 {
    ...
    public static void main(String[] args) {
        ...
        Curso cursito = cs.crearCurso();
        double ganancias = cs.calcularGananciaSemanal(cursito);
        System.out.println("");
        cs.mostrarCurso(cursito);
        System.out.println("");
        System.out.println("Las ganancias del curso son de " + ganancias);
    }
